...
namespace MedicalImageProcessor.WebApi.Controllers
{
    ...
    public class DetectionController : ControllerBase
    {
        ...
        [HttpPost("detect")]
        public async Task<ActionResult<DetectionResponseDto>> Detect(IFormFile imageFile)  // Приймаємо IFormFile безпосередньо
        {
            ...
            var result = await _service.ProcessAndDetectAsync(input);
